...
public class ItemActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        List<ItemImage> itemImages = Arrays.asList(new ItemImage("description", "https://demo-lia.univ-avignon.fr/cerimuseum/items/hsv/thumbnail"), new ItemImage("description2", "https://demo-lia.univ-avignon.fr/cerimuseum/items/hsv/thumbnail"));
